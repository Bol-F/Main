...
v = int(input("Enter a velocity (hours/kilometres) : "))
d = int(input("Enter a distance (kilometers) : "))

t = d / v
print(f'{t} - hours to finish the road')

# 4
"""Write a code in a proper way"""
...
new_str = f"{kocha} ko'chasi, {mahalla} mahallasi, {tuman} tumani, {viloyat} viloyati"
...
# 7
"""Working with the arithmetic expressions"""
